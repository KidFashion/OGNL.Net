...
namespace java.util
{
	 ...
	 * equals and GetHashCode methods are no longer well defined on a such a map.
	 *
	...
	interface Entry 
	{
		...
		/**
			 ...
			 *     (e.getKey()==null   ? 0 : e.getKey().GetHashCode()) ^
			 *     (e.getValue()==null ? 0 : e.getValue().GetHashCode())
				 * </pre>
			 * This ensures that <tt>e1.equals(e2)</tt> implies that
			 * <tt>e1.GetHashCode()==e2.GetHashCode()</tt> for any two Entries
			 * <tt>e1</tt> and <tt>e2</tt>, as required by the general
			 * contract of <tt>Object.GetHashCode</tt>.
			 *
