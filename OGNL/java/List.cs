...
namespace java.util
{
	 ...
	 * extreme caution is advised: the <tt>equals</tt> and <tt>GetHashCode</tt>
	...
	public interface List : Collection 
		 ...
		 *  while (i.hasNext()) {
		 *      Object obj = i.next();
		 *      GetHashCode = 31*GetHashCode + (obj==null ? 0 : obj.GetHashCode());
		 *  }
		 * </pre>
		 * This ensures that <tt>list1.equals(list2)</tt> implies that
		 * <tt>list1.GetHashCode()==list2.GetHashCode()</tt> for any two lists,
