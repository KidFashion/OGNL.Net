...
namespace ognl
{
	...
	public class OgnlParserTokenManager : OgnlParserConstants
	{
		...
		private object makeInt()
		{
			...
			{
			case 'l': case 'L':
				result = Util.ParseLong( s.Substring(0,s.Length -1), ibase );
				break;
		...
		static long[] jjbitVec3 = {
											0x0L, unchecked ((long)0xffffffffffffffffL), unchecked ((long)0xffffffffffffffffL), unchecked ((long)0xffffffffffffffffL)
										};
		...
		private int jjStopStringLiteralDfa_1(int pos, long active0, long active1)
					  {
						  switch (pos)
						  {
						  default :
		...
		private int jjStartNfa_1(int pos, long active0, long active1)
					  {
		...
		public static String[] jjstrLiteralImages = 
	{
		...
		*/
		...
		"\x7e","\x21","\x69\x6e\x73\x74\x61\x6e\x63\x65\x6f\x66","\x2e","\x28","\x29","\x74\x72\x75\x65","\x66\x61\x6c\x73\x65",
		...
		public static String[] lexStateNames = 
	{
		...
		public OgnlParserTokenManager(JavaCharStream stream, int lexState) : this(stream)
		{
			;
			SwitchTo(lexState);
		}
		...
		void MoreLexicalActions()
		{
			...
			case 72 :
				if (image == null)
					...
					image.Append(input_stream.GetSuffix(jjimageLen));
				jjimageLen = 0;
				charValue = image [ image.Length-1 ]; stringBuffer.Append(charValue);
				break;
			case 74 :
				if (image == null)
					image = new StringBuilder(new String(input_stream.GetSuffix(jjimageLen)));
